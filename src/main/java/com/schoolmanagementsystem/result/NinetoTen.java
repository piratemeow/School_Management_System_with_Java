...
public class NinetoTen extends SixtoEight{
    ...
    public NinetoTen(int id, double Ban1, double Ban2,double Eng1, double Eng2, double reli, double science , double math, double wellbeing , double crafts, double social, double economics, double history, double logic,double business)
    {
